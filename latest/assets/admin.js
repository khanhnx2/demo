...
(function () {
  ...
  function buildSide(active){
    var h = '<div class="side-brand"><svg class="icon gem" viewBox="0 0 24 24"><path d="M6 3h12l4 6-10 12L2 9Z"/></svg>Vân Hương</div>';
    ...
    h += '<div class="side-foot"><span class="avatar">SA</span><div><div style="color:#fff;font-size:12px;font-weight:600">Super Admin</div><div style="font-size:11px">admin@vanhuong.info</div></div></div>';
    return h;
  }
